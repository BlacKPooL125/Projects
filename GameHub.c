        ...
        else if (main_action == 3)
        {
            ...
            while (1)
            {
                ...
                if (admin_choice == 1)
                {
                    ...
                    else if (option3_action1 == 2)
                    {
                        clear_screen();
                        break;
                    }
                    
                    else if (option3_action1 == 3)
                    {
                        exit_program();
                        return 0;
                    }
